...
public class RobotContainer {
  ...
  //SYSID requests, comment out when not in testing.
  /*
  private final SwerveRequest.SysIdSwerveTranslation translation = new SwerveRequest.SysIdSwerveTranslation();
  private final SwerveRequest.SysIdSwerveRotation rotate = new SwerveRequest.SysIdSwerveRotation();
  private final SwerveRequest.SysIdSwerveSteerGains steer = new SwerveRequest.SysIdSwerveSteerGains();
  */
